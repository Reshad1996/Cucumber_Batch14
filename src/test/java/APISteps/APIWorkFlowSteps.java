...
public class APIWorkFlowSteps {
    ...
    public void the_status_code_for_creating_and_employee_is(Integer int1) {
        response.then().assertThat().statusCode(int1);
    }

    @Then("the response body contain key {string} and value {string}")
    public void the_response_body_contain_key_and_value(String key, String value) {
