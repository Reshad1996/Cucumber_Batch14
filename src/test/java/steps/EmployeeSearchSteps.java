...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    public void user_enter_valid_employee_id() {
        ...
        //sendText(empIdField,"41992A");
        //sendText(empIdField, ConfigReader.getPropertyValue("empID"));
        sendText(employeeList.empSearchIdField,"13802166");
    }
    ...
    public void user_enters_valid_employee_name() {
        ...
        //sendText(searchNameField, "Reshad Gulzada");
        sendText(employeeList.empSearchNameField,"Reshad Gulzada");
    }
